...
<?php
	if(isset($_POST['form1'])){
		try{
			...
			(post_title,post_description,post_image,post_price,cat_id,tag_id,post_date,post_timestamp) value(?,?,?,?,?,?,?,?)");
			$statement->execute(array($_POST['post_title'],$_POST['post_description'],$f1,$_POST['post_price'],$_POST['cat_id'],$tag_ids,$post_date,$post_timestamp));
...
<form action="" method="post" enctype="multipart/form-data">
	<table class="tbl1">
		...
		<tr>
			<td>
				<input class="small" type="text" name="post_price">
			</td>
		</tr>
		<tr>
